...
namespace pmdbs2X.Security.Defense.Win32
{
    internal static class Win32DebugDetector
    {
        ...
        public enum ProcessPermission : uint
        {
            ...
            END = PROCESS_TERMINATE | PROCESS_CREATE_THREAD | PROCESS_SET_SESSIONID | PROCESS_VM_OPERATION | PROCESS_VM_READ | PROCESS_VM_WRITE | PROCESS_DUP_HANDLE | PROCESS_CREATE_PROCESS | PROCESS_SET_QUOTA | PROCESS_SET_INFORMATION | PROCESS_QUERY_INFORMATION | PROCESS_SUSPEND_RESUME,
            ...
            PROCESS_ALL_ACCESS = END | DELETE | READ_CONTROL | WRITE_DAC | WRITE_OWNER | SYNCHRONIZE
        }
